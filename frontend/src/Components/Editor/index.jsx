...
//TODO: Code smell: onChangeText once passed cannot be updated. 
//Hence, we must ensure that the function runs without any state dependencies.
//The component needs to be updated to support this.
